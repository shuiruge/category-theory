...
<\body>
  ...
  We have studied presheaf. But presheaves are much fewer than the generic
  functors in our universe. To study the generic functor
  <math|F:<math-ss|C>\<rightarrow\><math-ss|D>> using what we have built, we
  shall relate <math|F> to a presheaf. The idea is mimicing the hom-functor
  <math|<math-ss|D><around*|(|-,Y|)>:<math-ss|D><rsup|op>\<rightarrow\><math-ss|Set>>.
  A natural way is putting <math|F> into the placeholder, which gives
  <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)>:<math-ss|C><rsup|op>\<rightarrow\><math-ss|Set>>.
  This is indeed a functor, thus presheaf. The functoriality results in the
  composition of functor <math|F> and hom-functor <math|D<around*|(|-,Y|)>>.
  The presheaf <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)>> can be seen
  as a generalization of hom-functor.

  As a presheaf on <math|<math-ss|C>>, when will
  <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)>> have a representation?
  Namely, given <math|F:<math-ss|C>\<rightarrow\><math-ss|D>> and
  <math|Y\<in\><math-ss|D>>, can we find a <math|X\<in\><math-ss|C>> such
  that

  <\equation*>
    <math-ss|D><around*|(|F<around*|(|-|)>,Y|)>\<cong\><math-ss|C><around*|(|-,X|)>?
  </equation*>

  By theorem <reference|theorem:universal element>, a presheaf <\footnote>
  ...
  <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)>>. By theorem
  <reference|theorem:universal element>, a universal element of
  <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)>> is a morphism
  <math|e\<in\><math-ss|D><around*|(|F<around*|(|W|)>,Y|)>> for some
  <math|W\<in\><math-ss|C>>, such that <math|<math-ss|D><around*|(|F<around*|(|-|)>,Y|)><around*|(|e|)>:<math-ss|C><around*|(|X,W|)>\<rightarrow\><math-ss|D><around*|(|F<around*|(|X|)>,Y|)>>
  ...
  <big-figure||<label|figure: Universality> This
  <hlink|figure|https://q.uiver.app/#q=>
  ...
  <big-figure||<label|figure: Universal Arrow Is Functorial> This
  <hlink|figure|https://q.uiver.app/#q=>
...
<\references>
  <\collection>
    ...
    <associate|auto-4|<tuple|2|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|auto-5|<tuple|3|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|auto-6|<tuple|1.2|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|auto-7|<tuple|1.3|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|auto-8|<tuple|1.4|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|auto-9|<tuple|1.4|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|figure: Composition Axiom|<tuple|1.3|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|figure: Identity Axiom|<tuple|1.4|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|figure: Universal Arrow Is
    Functorial|<tuple|1.2|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|figure: Universality|<tuple|1.1|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|footnote-1.1|<tuple|1.1|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|footnr-1.1|<tuple|1.1|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
    <associate|section: Universal arrows furnish natural
    structure|<tuple|2|?|../../.TeXmacs/texts/scratch/no_name_2.tm>>
  </collection>
</references>
